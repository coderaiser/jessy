...
test('jessy: cjs: arguments: no obj', (t) => {
...
test('jessy: cjs: result: value from object', (t) => {
    const obj = {
        hello: {
            world: 'something',
        },
...
test('jessy: cjs: result: value from empty object', (t) => {
    const obj = {};
...
test('jessy: cjs: result: missing value from empty object', (t) => {
...
test('jessy: cjs: result: missing value from object', (t) => {
    const actual = jessy('hello.world', {
        some: {
            value: 'hi',
        },
...
test('jessy: cjs: result: empty selector', (t) => {
    const obj = {
        hello: {
            world: 'something',
        },
...
test('jessy: cjs: result: value is an object', (t) => {
    const obj = {
        hello: {},
    };
...
test('jessy: cjs: name with "_": similar', (t) => {
    const obj = {
        hello: {
            world: 'hello',
            world_min: 'something',
...
test('jessy: cjs: "/" at the beginning', (t) => {
    const obj = {
        hello: {
            world: 'hello',
        },
